      ...
      >
        ...
        <div className="flex items-center justify-center">
          <button
            type="button"
            onClick={dismissSupportPrompt}
            className="rounded-2xl bg-[#f4f4f5] px-6 py-3 text-[15px] font-semibold text-gray-600 transition-all hover:bg-gray-200 active:scale-[0.98] dark:bg-[#27272a] dark:text-gray-300 dark:hover:bg-[#3f3f46]"
          >
            关闭
          </button>
        </div>
